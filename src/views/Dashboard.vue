          ...
          <b-nav vertical>
            ...
            <h5>
              <router-link to="/Profile" style="color: white"
                ><b>My Account</b></router-link
              >
            </h5>
            <hr />
            <h5>
              <router-link to="/Income" style="color: white"
                ><b>+ Add Your Income</b></router-link
              >
            </h5>
            <hr />
            <h5>
              <router-link to="/Expenses" style="color: white"
                ><b>+ Add Your Expense</b></router-link
              >
            </h5>
            <hr />
            <h5>
              <router-link to="/Daybook" style="color: white"
                ><b>View Your Daybook</b></router-link
              >
            </h5>
            <hr />
          </b-nav>
